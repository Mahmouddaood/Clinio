...
class Menu extends React.PureComponent {
  ...
  _setContainerRef = ref => (this._container = ref);
  ...
  _onMenuLayout = e => {
    ...
    this.setState(
      ...
      () => {
        const { menuSizeAnimation, opacityAnimation } = this.state;
        Animated.parallel([
  ...
  hide = () => {
    ...
    Animated.timing(opacityAnimation, {
      ...
      this.setState(
        ...
        () => {
          if (Platform.OS === "ios") if (onHidden) return onHidden();
        }
      );
    });
  };
  ...
  render() {
    ...
    return (
      <View
        ...
        testID={testID}
      >
        <View style={buttonContainerStyles} onLayout={this._onButtonLayout}>
          {button}
        </View>
